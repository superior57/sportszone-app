		...
		<div className={ `player-control${className ? ` ${className}` : ''}` } >
			...
			<div className='d-flex mt-2' style={{
				...
				<div className='d-flex align-items-center pr-4'>
					<Button className='player-control__button d-flex align-items-center' color='link' onClick={ onShowAnnotation }>
						{
							showAnnotation ? <MdMovieFilter className='player-control__icon' /> : <MdMovieCreation className='player-control__icon' />
						}
					</Button>
					<Button className='player-control__button d-flex align-items-center' color='link' onClick={ onFullScreen }>
						{
							fullscreen ? <MdFullscreenExit className='player-control__icon' /> : <MdFullscreen className='player-control__icon' />
						}
					</Button>
					<ButtonGroup>
